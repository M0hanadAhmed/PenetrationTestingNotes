# TryHackMe — Operation Coldstart (Volt Labs)

**Room theme:** SSRF against a hostname allow-list, chained into leaked SSH credentials, then privilege escalation via a root cron job vulnerable to the classic `tar` wildcard/checkpoint injection.
...
| # | Description | Flag |
|---|---|---|
| 1 | `user.txt` | `THM{96dc7bd50d2fb98fcece01560788b5ab}` |
| 2 | `root/flag.txt` | `THM{e6ee84a483d67ade06936fcfd1433e8a}` |
